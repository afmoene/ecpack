...
C
     ...
     &	OutF,MMax,MaxChan,Channels,Mok(NMax),Cok(NMax,NMax)
     ...
     &	PDetrend,AnyTilt,DumPitch,DumYaw,DumRoll,DumTilt
...
C
     ...
     &	MIndep(NMax),CIndep(NMax,NMax),
     &  Mok(NMax),Cok(NMax,NMax)
